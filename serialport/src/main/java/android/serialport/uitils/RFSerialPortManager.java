...
import android.serialport.serial.RFSerialReadThread;
...
public class RFSerialPortManager {
    private static final String TAG = "SerialPortManager";
    private RFSerialReadThread mReadThread;
    private OutputStream mOutputStream;

    private static RFSerialPortManager sManager;

    public static RFSerialPortManager instance() {
        if (sManager == null) sManager = new RFSerialPortManager();
        return sManager;
    }

    private SerialPort mSerialPort;

    private RFSerialPortManager() {
        // 线程池，用来处理收到的数据
    ...
    public SerialPort open(String devicePath, String baudrateString) {
        ...
        try {
            ...
            mReadThread = new RFSerialReadThread(mSerialPort.getInputStream(), devicePath);
            mReadThread.start();
